...
using static MinesweeperMilestone.Models.Board;
...
namespace MinesweeperMilestone.Services
{
    public class GameService
    {
        ...
        // Hold the board in memory for this service instance
        private Board _board;

        public GameService(Board currentBoard)
        {
            _board = currentBoard;
        }

        // Bridges to map old variables to the new ones here for ease of use
        private int size => _board.size;
        private int difficulty => _board.difficulty;
        private Cell[,] cells => _board.cells;

        private int Score
        {
            get => _board.Score;
            set => _board.Score = value;
        }

        private Board.GameState state
        {
            get => _board.state;
            set => _board.state = value;
        }

        private int numBombs
        {
            get => _board.numBombs;
            set => _board.numBombs = value;
        }

        private int rewardsRemaining
        {
            get => _board.rewardsRemaining;
            set => _board.rewardsRemaining = value;
        }

        private int powersAvailable
        {
            get => _board.powersAvailable;
            set => _board.powersAvailable = value;
        }

        private DateTime startTime
        {
            get => _board.startTime;
            set => _board.startTime = value;
        }

        private DateTime endTime
        {
            get => _board.endTime;
            set => _board.endTime = value;
        }
        private int score
        {
            get => _board.score;
